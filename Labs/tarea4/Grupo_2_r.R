...
## Script R y Python - Datos de la ComisiÃ³n de la Verdad y ReconciliaciÃ³n----
...
###Filtrar la base de datos segÃºn los siguientes tipos de eventos: desapariciÃ³n, secuestros, reclutamiento forzado y muertes en atentados----


datossavDesaparicion <- filter(datossav, LDS_LDT == 1)  # DesapariciÃ³n
...
###Crear una base de datos con el total de eventos de violencia segÃºn su tipo a nivel departamento----
...
#Se genera la tabla que presenta, por departamento, el total de eventos de violencia segÃºn tipo
...
###Crear una base de datos con el total de eventos de violencia segÃºn su tipo a nivel distrito---- 


#Se genera la tabla que presenta, por distrito, el total de eventos de violencia segÃºn tipo
...
###Crear una base de datos con el total de eventos de violencia segÃºn su tipo a nivel departamento y periodo----
