...
\hline\hline
\multicolumn{5}{l}{\footnotesize Notes: LPM regressions. Standard errors are clustered at the class level (12 clusters). Dependent variables: dummy equal to one if the student majored in (i) social science (other than economics), (ii) arts, (iii) communication studies, or (iv) humanities.}\vspace{-.25em} \\
