...
stargazer(tabla_ed, title = "Descriptive Statistics", digits = 2, 
          ...
          min.max = T,
          summary.stat = c("mean", "sd", "n","min","max"), # Orden de estadísticos
          out = "../../trabajo_final/Grupo8/tabla_ed_R.tex")

# Se crea un vector de las variables de control para realizar las regresiones

controles <- c('female_prof', 'instate', 'freshman', 'american',
...
ols_model1_t3 <- lm_robust(took_year ~ treat2016 + yr_2016 + treatment_class, data = datos,
...
model2_t3_formula <- as.formula(paste("took_year","~",
                      paste("treat2016","yr_2016", "treatment_class",
                      paste(controles, collapse = "+"),  sep="+")))

ols_model2_t3 <- lm_robust(model2_t3_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model2_t3)

# Modelo 3 - Tabla3

ols_model3_t3 <- lm_robust(tookanother ~ treat2016 + yr_2016 + treatment_class, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model3_t3)
...
ols_model4_t3 <- lm_robust(model4_t3_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model4_t3)

# Creamos la tabla de resultados que agrupa los modelos de la tabla 3

texreg(list(ols_model1_t3, ols_model2_t3, ols_model3_t3, ols_model4_t3),
       ...
       file = "../../trabajo_final/Grupo8/tabla_3_reg_R.tex")

## Regresiones Tabla 4----------------------------------------

# Modelo 1 - Tabla4

ols_model1_t4 <- lm_robust(numeconclass ~ treat2016 + yr_2016 + treatment_class, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model1_t4)
...
ols_model2_t4 <- lm_robust(model2_t4_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model2_t4)

# Modelo 3 - Tabla4

ols_model3_t4 <- lm_robust(econmajor ~ treat2016 + yr_2016 + treatment_class, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model3_t4)
...
ols_model4_t4 <- lm_robust(model4_t4_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model4_t4)

# Creamos la tabla de resultados que agrupa los modelos de la tabla 4

texreg(list(ols_model1_t4, ols_model2_t4, ols_model3_t4, ols_model4_t4),
       ...
       stars = c(0.01, 0.05, 0.1),
       custom.gof.rows = list("Controls" = c("No","Yes", "No","Yes")),
       file = "../../trabajo_final/Grupo8/tabla_4_reg_R.tex")
...
ols_model1_t5 <- lm_robust(model1_t5_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model1_t5)
...
ols_model2_t5 <- lm_robust(model2_t5_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model2_t5)
...
ols_model3_t5 <- lm_robust(model3_t5_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model3_t5)
...
ols_model4_t5 <- lm_robust(model4_t5_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model4_t5)

# Creamos la tabla de resultados que agrupa los modelos de la tabla 5

texreg(list(ols_model1_t5, ols_model2_t5, ols_model3_t5, ols_model4_t5),
       ...
       file = "../../trabajo_final/Grupo8/tabla_5_reg_R.tex")
...
ols_model1_t6 <- lm_robust(model1_t6_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model1_t6)
...
ols_model2_t6 <- lm_robust(model2_t6_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model2_t6)
...
ols_model3_t6 <- lm_robust(model3_t6_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model3_t6)
...
ols_model4_t6 <- lm_robust(model4_t6_formula, data = datos,
                           clusters = class_fe2, se_type = "stata")

summary(ols_model4_t6)

# Creamos la tabla de resultados que agrupa los modelos de la tabla 6

texreg(list(ols_model1_t6, ols_model2_t6, ols_model3_t6, ols_model4_t6),
       ...
       stars = c(0.01, 0.05, 0.1),
       custom.gof.rows = list("Controls" = c("Yes","Yes", "Yes","Yes")),
       file = "../../trabajo_final/Grupo8/tabla_6_reg_R.tex")
...
sum_model1_t4 <- summary(ols_model1_t4)$coefficients
sum_model2_t4 <- summary(ols_model2_t4)$coefficients
sum_model3_t4 <- summary(ols_model3_t4)$coefficients
sum_model4_t4 <- summary(ols_model4_t4)$coefficients
...
model1_t4_coef = sum_model1_t4[2,1]
model2_t4_coef = sum_model2_t4[2,1]
model3_t4_coef = sum_model3_t4[2,1]
model4_t4_coef = sum_model4_t4[2,1]


# Extraemos los intervalos de confianza

model1_lower = sum_model1_t4[2,5]
model1_upper = sum_model1_t4[2,6]

model2_lower = sum_model2_t4[2,5]
model2_upper = sum_model2_t4[2,6]

model3_lower = sum_model3_t4[2,5]
model3_upper = sum_model3_t4[2,6]

model4_lower = sum_model4_t4[2,5]
model4_upper = sum_model4_t4[2,6]
...
tabla[1,1]<- model1_t4_coef
tabla[2,1]<- model2_t4_coef
tabla[3,1]<- model3_t4_coef
tabla[4,1]<- model4_t4_coef
...
print(tabla_est_R, file = "../../trabajo_final/Grupo8/tabla_est_R.tex")
...
ggsave("../../trabajo_final/Grupo8/Gráfico_Treat2016_R.png"
       , height = 8  
       , width = 12  
       , dpi = 320 )
